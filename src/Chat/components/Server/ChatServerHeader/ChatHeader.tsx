    ...
    return (
        <div className="flex text-base-content h-12">
            ...
            <div className="flex-1 bg-gray-750 flex items-center justify-between border-b border-gray-900 px-4">
                ...
                <div className="flex items-center"><a href="src/pages/Chat/components/Server/ChatServerHeader/ChatHeader#" className="ml-4">
                ...
                </a> <a href="src/pages/Chat/components/Server/ChatServerHeader/ChatHeader#" className="ml-4">
                    ...
                    <form action="src/pages/Chat/components/Server/ChatServerHeader/ChatHeader#" className="relative"><input type="text" placeholder="Search" className="rounded bg-gray-900 text-gray-200 text-xs px-2 py-1"/>
